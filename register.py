...
class Register:
    def __init__ (self,root):
        ...
        #=========bg image=============
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Shiwani Gupta\OneDrive\Desktop\Attendence system\image\image.png")
        bg_lbl=Label(self.root,image=self.bg)
        bg_lbl.place(x=0,y=0,relwidth=1,relheight=1)
        
        
        #=========left image=========
        self.bg1=ImageTk.PhotoImage(file=r"C:\Users\Shiwani Gupta\OneDrive\Desktop\Attendence system\image\Women-in-Tech.jpg")
