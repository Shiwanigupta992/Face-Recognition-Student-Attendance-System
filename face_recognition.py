...
class Face_Recognition :
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="FACE RECOGNITION ",font=("times new roman",30,"bold"),bg="white",fg="navy blue")
        title_lbl.place(x=0,y=0,width=1530,height=45)

        img_top=Image.open(r"C:\Users\Shiwani Gupta\OneDrive\Desktop\Attendence system\image\Face2.jpeg")
        ...
        img_bottom=Image.open(r"image\fFACE RECO.jpg")
     ...
     # button
        b1_1=Button(f_lbl,text="Face Recognition",command=self.face_recog,cursor="hand2",font=("times new roman",18,"bold"),bg="white",fg="navy blue")
